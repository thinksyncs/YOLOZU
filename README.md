...
| Long-tail post-hoc + report | `yolozu calibrate --method fracal ... --output reports/predictions_calibrated.json && yolozu eval-long-tail ... --output reports/long_tail_eval.json` | (same via `python3 tools/yolozu.py ...`) |
