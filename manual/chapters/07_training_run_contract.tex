...
\begin{itemize}
  ...
  \item A deterministic artifact layout under \path{runs/<run_id>/}:
    ...
    \end{itemize}
  \item Export and parity artifacts are generated automatically in contracted runs:\
