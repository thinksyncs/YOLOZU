...
\begin{itemize}
  \item gate/control: \cmd{--enable}/\cmd{--disable}, \cmd{steps}, \cmd{damping}, \cmd{fd\_eps}
  \item target toggles: \cmd{refine\_offsets} (offsets-first rollout)
  \item residual weights: \cmd{w\_depth}, \cmd{w\_mask}, \cmd{w\_reg}
