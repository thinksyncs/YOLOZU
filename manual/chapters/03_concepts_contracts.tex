...
Frameworks such as Detectron2, MMDetection, and VOLOX frequently export detection results in COCO format. Typical fields include:
\begin{itemize}
  \item \cmd{image_id}
...
\begin{itemize}
  ...
  \item \textbf{Output}: Per-image \cmd{tetections} must include \cmd{class_id}, \cmd{score}, and \cmd{box} (typically formatted as \cmd{cxcywh_norm}), alongside any task-specific optional fields.
