...
\ChapterMeta{
Describe post-hoc calibration and long-tail adjustments that transform confidence scores while preserving geometry.
}{
Can improve thresholding behavior and long-tail metrics without retraining, while keeping the transform reproducible via stats artifacts.
}{
Requires a dataset + predictions artifact; method-specific knobs apply, and outputs should typically be written as separate calibrated artifacts.
}
