...
\subsection{Safety boundaries and guardrails}
Reuse the standard TTT guardrails (\cmd{max\_grad\_norm}, \cmd{max\_update\_norm},
\cmd{max\_total\_update\_norm}, \cmd{max\_loss\_ratio}) and rollback-on-stop behavior.
...
\begin{itemize}
  ...
  \item thresholds: \cmd{ttt.eata.conf_min}, \cmd{ttt.eata.entropy_min}, \cmd{ttt.eata.entropy_max}, \cmd{ttt.eata.min_valid_dets}
