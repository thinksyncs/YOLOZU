...
\ChapterMeta{
This chapter explains controlled test-time adaptation (Tent/MIM), presets, guard rails, and reset policies for fair comparisons.
}{
...
Use it when there is clear domain shift; comparisons require fixed image sets, bounded \cmd{--ttt-max-batches}, and careful seed and reset policy control.
}
