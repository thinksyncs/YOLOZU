...
Use it when tools are invoked via the declared entrypoints and validated with \cmd{python3 tools/validate_tool_manifest.py}; path-resolution rules matter for automation.
}
