...
Use it when you run validators on the exact artifacts you evaluate; pay attention to \cmd{--pred-root} and consistent class ordering across exporter and evaluator.
}
