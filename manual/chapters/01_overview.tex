...
\ChapterMeta{
This chapter introduces \yolozu{}'s contract-first evaluation approach, key repository entry points, and the two CLI surfaces.
}{
It helps you choose the right workflow quickly and avoid confusion about where commands and artifacts live.
}{
No prerequisites beyond reading; rely on \cmd{--help} for the CLI you are using and treat JSON artifacts as the stable interface.
}
