...
\ChapterMeta{
Cover continual fine-tuning across tasks/domains and the evaluation of forgetting using recorded run artifacts.
}{
Helps mitigate catastrophic forgetting and makes per-task metrics comparable over a training sequence.
}{
Requires continual configs and run artifacts (e.g., \cmd{continual\_run.json}); optional replay/LoRA settings change compute and forgetting behavior.
}
