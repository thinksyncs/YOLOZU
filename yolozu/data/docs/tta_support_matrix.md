...
- Protocol overview: `docs/ttt_protocol.md`
- How evaluation stays comparable: `docs/predictions_schema.md`
- External inference entry point: `docs/external_inference.md`
